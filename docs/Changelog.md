...
- 2026-03-26: Released pyfreeproxy v0.4.0 — Partial code refactoring was completed to remove the Playwright dependency and switch to DrissionPage; multiple free proxy sources were added; fixed some known bugs.
