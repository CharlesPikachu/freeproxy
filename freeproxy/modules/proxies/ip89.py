...
class IP89ProxiedSession(BaseProxiedSession):
    ...
    def refreshproxies(self):
        ...
        headers = {
            ...
            "Host": "api.89ip.cn", "Referer": "https://api.89ip.cn/tqdl.html?api=1&num=200&port=&address=&isp=", "sec-ch-ua": '"Chromium";v="142", "Google Chrome";v="142", "Not_A Brand";v="99"', "sec-ch-ua-mobile": "?0", "sec-ch-ua-platform": '"Windows"', "Sec-Fetch-User": "?1",
