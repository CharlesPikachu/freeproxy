...
class DatabayProxiedSession(BaseProxiedSession):
    ...
    def refreshproxies(self):
        ...
        urls = ['https://cdn.jsdelivr.net/gh/databay-labs/free-proxy-list/socks5.txt', 'https://cdn.jsdelivr.net/gh/databay-labs/free-proxy-list/http.txt', 'https://cdn.jsdelivr.net/gh/databay-labs/free-proxy-list/https.txt']
        headers = {
            "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7", "accept-encoding": "gzip, deflate, br, zstd", "accept-language": "zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7", "sec-fetch-dest": "document",
            "cache-control": "max-age=0", "if-none-match": 'W/"6dbd-ytmA54vS1G4OuZa75LiLV1DQVdE"', "sec-ch-ua": '"Chromium";v="142", "Google Chrome";v="142", "Not_A Brand";v="99"', "priority": "u=0, i", "sec-ch-ua-platform": '"Windows"', "sec-ch-ua-mobile": "?0", "sec-fetch-mode": "navigate",
            "sec-fetch-site": "none", "sec-fetch-user": "?1", "upgrade-insecure-requests": "1", "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36",
        }
        # obtain proxies
        for url in urls:
