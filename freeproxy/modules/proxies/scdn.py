...
class SCDNProxiedSession(BaseProxiedSession):
    ...
    def refreshproxies(self):
        ...
        for page in range(1, self.max_pages+1):
            # --https
            try:
                resp = session.get(f'https://proxy.scdn.io/api/get_proxy.php?protocol=https&count=20&page={page}', headers=self.getrandomheaders(headers_override=headers), timeout=60)
            ...
            # --http
            try:
                resp = session.get(f'https://proxy.scdn.io/api/get_proxy.php?protocol=http&count=20&page={page}', headers=self.getrandomheaders(headers_override=headers), timeout=60)
                resp.raise_for_status()
            ...
            # --socks4
            try:
                resp = session.get(f'https://proxy.scdn.io/api/get_proxy.php?protocol=socks4&count=20&page={page}', headers=self.getrandomheaders(headers_override=headers), timeout=60)
                resp.raise_for_status()
            ...
            # --socks5
            try:
                resp = session.get(f'https://proxy.scdn.io/api/get_proxy.php?protocol=socks5&count=20&page={page}', headers=self.getrandomheaders(headers_override=headers), timeout=60)
                resp.raise_for_status()
