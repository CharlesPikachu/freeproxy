...
class ProxiflyProxiedSession(BaseProxiedSession):
    ...
    def refreshproxies(self):
        # initialize
        self.candidate_proxies, urls = [], ['https://cdn.jsdelivr.net/gh/proxifly/free-proxy-list@main/proxies/all/data.json']
        country_codes = [
            "AE", "AM", "AO", "AR", "AT", "AU", "BA", "BD", "BE", "BR", "BY", "CA", "CH", "CL", "CM", "CN", "CO", "CR", "CY", "CZ", "DE", "DK", "DO", "EC", "EE", "EG", "ES", "FI", "FR", "GB", "GE", "GR", "GT", "HK", "HN", "HU", "ID", "IN", "IQ", "IR", "IT", "JP", "KE", 
