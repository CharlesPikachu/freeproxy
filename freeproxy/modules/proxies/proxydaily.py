...
class ProxydailyProxiedSession(BaseProxiedSession):
    ...
    def refreshproxies(self):
        ...
        for page in range(1, self.max_pages+1):
            ...
            try: (resp := session.get('https://proxy-daily.com/api/serverside/proxies', headers=self.getrandomheaders(base_headers=headers), params=params)).raise_for_status(); data_items = resp.json()['data']
