...
- 2026-09-16: Released pyfreeproxy v0.5.2 — Perform monthly code maintenance, removed `TrustyTechProxiedSession`, added `HProxyProxiedSession`, fixed several proxy sources, and improved IDE hints.
...
| [ChillyProxyProxiedSession](https://chillyproxy.com/tool-free-proxy-list)              | [ChillyProxy](https://chillyproxy.com/tool-free-proxy-list)                 | ✔           | ✔         | ✔         | ✔         | [advfp.py](https://github.com/CharlesPikachu/freeproxy/blob/master/freeproxy/modules/proxies/chillyproxy.py)                    |
...
| [FreeProxyWorldProxiedSession](https://www.freeproxy.world/)                           | [FreeProxyWorld](https://www.freeproxy.world/)                              | ✔           | ✔         | ✔         | ✔         | [freeproxyworld.py](https://github.com/CharlesPikachu/freeproxy/blob/master/freeproxy/modules/proxies/freeproxyworld.py)        |
...
| [ProxySpaceProxiedSession](https://proxyspace.pro/)                                    | [ProxySpace.pro](https://proxyspace.pro/)                                   | ✔           | ✔         | ✔         | ✔         | [proxyspace.py](https://github.com/CharlesPikachu/freeproxy/blob/master/freeproxy/modules/proxies/proxyspace.py)                |
| [ProxyListerProxiedSession](https://proxylister.com/free-proxies)                      | [ProxyLister](https://proxylister.com/free-proxies)                         | ✔           | ✔         | ✔         | ✔         | [proxylister.py](https://github.com/CharlesPikachu/freeproxy/blob/master/freeproxy/modules/proxies/proxylister.py)              |
